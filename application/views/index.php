                            ...
                            <div class="header-section">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                        <h1>Bienvenido <strong><?php echo $sesio['Nombre'];?> <?echo $sesio['Apellidos'];?></strong><br><small>Que tengas un buen dia!</small></h1>
                                    </div>
                                    <!-- END Main Title -->
                                            ...
                                            <ul class="timeline-list">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?php echo base_url();?>assets/img/placeholders/photos/photo1.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                                ...
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?php echo base_url();?>assets/img/placeholders/photos/photo23.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-advanced widget-advanced-alt">
                                        ...
                                        <div class="widget-header text-left">
                                            ...
                                            <img src="<?php echo base_url();?>assets/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
                                            ...
                                            <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
                                                <div class="row">
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo15.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?php echo base_url();?>assets/img/placeholders/photos/photo15.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo5.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?php echo base_url();?>assets/img/placeholders/photos/photo5.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo6.jpg" class="gallery-link" title="Image Info">
                                                            <img src="img/placeholders/photos/photo6.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo base_url();?>assets/img/placeholders/photos/photo13.jpg" class="gallery-link" title="Image Info">
