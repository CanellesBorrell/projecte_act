                                            ...
                                            <div class="widget-advanced">
                                                ...
                                                <div class="widget-header text-center themed-background-dark-default">
                                                    <h3 class="widget-content-light">
                                                        <a href="<?php echo base_url()?>index.php/grupos/asignaturasCursadas/<?php echo $listargrupos['id_grupo']; ?>" class="themed-color-default"><?php echo $listargrupos['Grupo']; ?></a><br>
                                                    </h3>
                                                </div>
                                                <!-- END Widget Header -->
