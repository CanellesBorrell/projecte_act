                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <!-- Course Widget -->
                                     <?php foreach($data as $listargruposAsig){ ?>
                                    <div class="col-md-4">
                                        <div class="widget">
                                            <div class="widget-advanced">
                                                ...
                                                <div class="widget-header text-center themed-background-dark-default">
                                                    <h3 class="widget-content-light">
                                                        <a href="page_ready_elearning_course_lessons.html" class="themed-color-default"><?php echo $listargruposAsig['asignatura']; ?></a><br>
                                                    </h3>
                                                </div>
                                                <!-- END Widget Header -->
