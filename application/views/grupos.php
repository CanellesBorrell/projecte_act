        ...
        <div id="modal-agrupar" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal Body -->
                    <div class="modal-body">
                        <form action="Grupos/insertarGAsignaturas" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            <fieldset>
                                <div class="form-group">
                                
                                               <input type = "hidden" name = "valor_id" id="valor_id"/>
                                                <label class="col-md-4 control-label" for="g-asignaturas">Selecciona las asignaturas</label>
                                                <div class="col-md-6">
                                                    <select id="g-asignaturas" name="g-asignaturas[]" class="select-chosen" data-placeholder="Selecciona las asignaturas" style="width: 250px;" multiple>
